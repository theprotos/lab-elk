...
sudo sh -c "echo \"node.name: data1\" >> /etc/elasticsearch/elasticsearch.yml"
sudo sh -c "echo \"network.host: 192.168.100.11\" >> /etc/elasticsearch/elasticsearch.yml"
sudo systemctl start elasticsearch.service
sudo service elasticsearch restart

sudo sh -c "echo \"node.name: node1\" >> /etc/logstash/logstash.yml"
sudo sh -c "echo \"http.host: 192.168.100.11\" >> /etc/logstash/logstash.yml"
